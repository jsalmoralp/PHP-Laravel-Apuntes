...
<a class="float-right ml-2 btn btn-secondary btn-sm" href="{{route('admin.tags.index')}}">Lista de Etiquetas</a>
@endcan
@can('admin.tags.create')
<a class="float-right ml-2 btn btn-success btn-sm" href="{{route('admin.tags.create')}}">Nueva Etiqueta</a>
@endcan
@can('admin.tags.edit')
<a class="float-right ml-2 btn btn-primary btn-sm" href="{{route('admin.tags.edit', $tag)}}">Editar Etiqueta</a>
@endcan
