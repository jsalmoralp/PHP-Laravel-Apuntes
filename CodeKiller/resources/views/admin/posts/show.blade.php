...
<a class="float-right ml-2 btn btn-secondary btn-sm" href="{{route('admin.posts.index')}}">Lista de Artículo</a>
@endcan
@can('admin.posts.create')
<a class="float-right ml-2 btn btn-success btn-sm" href="{{route('admin.posts.create')}}">Nuevo Artículo</a>
@endcan
@can('admin.posts.edit')
<a class="float-right ml-2 btn btn-primary btn-sm" href="{{route('admin.posts.edit', $post)}}">Editar Artículo</a>
@endcan
