        ...
        <section class="grid grid-cols-1 gap-6 mt-5 md:grid-cols-2 lg:grid-cols-3">
            ...
            <article class="w-full bg-gradient-to-br from-blue-600 to-blue-300 bg-center bg-cover rounded-lg h-80">
                <div class="flex flex-col justify-center w-full h-full px-8">
                    ...
                    <h2 class="mt-2 text-4xl font-bold leading-8 text-white">
                        <a target="_blank" href="https://github.com/jsalmoralp/PHP-Laravel-Apuntes">Laravel</a>
                        <br><small>{{__('Notes')}}</small>
                    </h2>
                </div>
            </article>
            <article class="w-full bg-gradient-to-br from-blue-600 to-yellow-500 bg-center bg-cover rounded-lg h-80">
                <div class="flex flex-col justify-center w-full h-full px-8">
                    ...
                    <h2 class="mt-2 text-4xl font-bold leading-8 text-white">
                        <a target="_blank" href="https://github.com/jsalmoralp/Kotlin-AndroidStudio-Apuntes">AndroidStudio</a>
                        <br><small>{{__('Notes')}}</small>
                    </h2>
                </div>
            </article>
            <article class="w-full bg-gradient-to-br from-blue-600 to-blue-300 bg-center bg-cover rounded-lg h-80">
                <div class="flex flex-col justify-center w-full h-full px-8">
                    ...
                    <h2 class="mt-2 text-4xl font-bold leading-8 text-white">
                        <a target="_blank" href="https://github.com/jsalmoralp/PHP-Librerias">PHP</a>
                        <br><small>{{__('Library')}}</small>
                    </h2>
                </div>
            </article>
            <article class="w-full bg-gradient-to-br from-blue-600 to-blue-300 bg-center bg-cover rounded-lg h-80">
                <div class="flex flex-col justify-center w-full h-full px-8">
                    ...
                    <h2 class="mt-2 text-4xl font-bold leading-8 text-white">
                        <a target="_blank" href="https://github.com/jsalmoralp/PHP-Composer-RiotApi_LeagueOfLegends">PHP RiotAPI</a>
                        <br><small>Lector web Json</small>
                    </h2>
                </div>
            </article>
            <article class="w-full bg-gradient-to-br from-yellow-600 to-yellow-200 bg-center bg-cover rounded-lg h-80">
                <div class="flex flex-col justify-center w-full h-full px-8">
                    ...
                    <h2 class="mt-2 text-4xl font-bold leading-8 text-white">
                        <a target="_blank" href="https://github.com/jsalmoralp/JavaScript-DiscordBot-General">DiscordBot</a>
                        <br><small>General Cow</small>
                    </h2>
                </div>
            </article>
            <article class="w-full bg-gradient-to-br from-red-400 to-blue-400 bg-center bg-cover rounded-lg h-80">
                <div class="flex flex-col justify-center w-full h-full px-8">
                    ...
                    <h2 class="mt-2 text-4xl font-bold leading-8 text-white">
                        <a target="_blank" href="https://github.com/jsalmoralp/Java-PluginMinecraft-AllInOne">Plugin Minecraft</a>
                        <br><small>All In One</small>
                    </h2>
                </div>
            </article>
            <article class="w-full bg-gad bg-gradient-to-br from-blue-500 bg-yellow-300 bg-cover rounded-lg h-80">
                <div class="flex flex-col justify-center w-full h-full px-8">
                    ...
                    <h2 class="mt-2 text-4xl font-bold leading-8 text-white">
                        <a target="_blank" href="https://github.com/jsalmoralp/Python-DiscordBot-Apuntes">Discord Bot</a>
                        <br><span>Apuntes</span>
                    </h2>
                </div>
            </article>
        </section>
