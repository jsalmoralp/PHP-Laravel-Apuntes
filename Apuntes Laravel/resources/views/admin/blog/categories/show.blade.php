...
<a class="float-right ml-2 btn btn-secondary btn-sm" href="{{route('admin.blog.categories.index')}}">Lista de Categorías</a>
@endcan
...
<a class="float-right ml-2 btn btn-primary btn-sm" href="{{route('admin.blog.categories.edit', $category)}}">Editar Categoría</a>
@endcan
...
@endcan
<h1>Blog - Detalle de la Categoría</h1>
@stop
