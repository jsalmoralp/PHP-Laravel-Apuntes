        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$role->id}}</td>
                    <td>
                        @can('admin.admin.roles.show')
                        <a href="{{route('admin.admin.roles.show', $role)}}">{{$role->name}}</a>
                        @else
                        {{$role->name}}
                        @endcan
                    </td>
                    <td width="10px">
                        ...
                        <a class="btn btn-primary btn-sm" href="{{route('admin.admin.roles.edit', $role)}}">Editar</a>
                        @endcan
                    </td>
                    <td width="10px">
