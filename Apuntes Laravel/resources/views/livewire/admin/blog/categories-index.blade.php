            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{route('admin.blog.categories.show', $category)}}">{{$category->name}}</a>
                        @else
                        {{$category->name}}
                        @endcan
                    </td>
                    <td width='10px'>
                        ...
                        <a class="btn btn-primary btn-sm" href="{{route('admin.blog.categories.edit', $category)}}">Editar</a>
                        @endcan
                    </td>
                    <td width='10px'>
