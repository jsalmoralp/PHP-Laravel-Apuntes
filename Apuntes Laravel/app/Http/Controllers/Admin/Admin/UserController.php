...
class UserController extends Controller
{
    ...
    {
        $this->middleware('can:admin.admin.users.index')->only('index');
        $this->middleware('can:admin.admin.users.create')->only('create', 'store');
        $this->middleware('can:admin.admin.users.edit')->only('edit', 'update');
        $this->middleware('can:admin.admin.users.destroy')->only('destroy');
    }
